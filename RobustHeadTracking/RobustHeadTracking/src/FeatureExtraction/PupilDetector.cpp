...
void PupilDetector::findPupilCoordinates(cv::Mat &grayFrame, cv::Mat &original, cv::Mat &drawableFrame) {
    ...
    circle(drawableFrame, leftEyeEllipse.center, 3, cv::Scalar(0,255,0), -1);
    cvtColor(leftEye, leftEye, CV_GRAY2BGR);
    cv::circle(leftEye, cv::Point(leftEyeEllipse.center.x * leftEye.cols / 200, leftEyeEllipse.center.y), 5, cv::Scalar(0,255,0), -1);
    imshow("Left eye", leftEye);
    
    circle(drawableFrame, rightEyeEllipse.center, 3, cv::Scalar(0,255,0), -1);
    cvtColor(rightEye, rightEye, CV_GRAY2BGR);
    cv::circle(rightEye, cv::Point(rightEyeEllipse.center.x * rightEye.cols / 200, rightEyeEllipse.center.y), 5, cv::Scalar(0,255,0), -1);
